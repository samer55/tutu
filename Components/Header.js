...
import argonTheme from '../constants0/Theme';
  ...
  renderSearch = () => {
    ...
    return (
      <Input
        ...
        iconContent={<Icon size={16} color={theme.COLORS.MUTED} name="md-search" family="ArgonExtra" />}
      />
    );
  }
  renderOptions = () => {
    ...
    return (
      <Block style={headerStyles}>
        <NavBar
          ...
          left={
            <Icon
              name={back ? 'ios-arrow-back' : null} family="ArgonExtra"
